...
Usage:
    ...
    ./music4.py -e 16 -w /home/ubuntu/nervana/music -r 0 -s music4.pkl -v
"""

from neon.util.argparser import NeonArgparser
from neon.initializers import Gaussian, GlorotUniform
from neon.layers import Conv, Pooling, GeneralizedCost, Affine, BiRNN, DeepBiRNN, RecurrentMean
...
layers = [Conv((2, 2, 4), init=init, activation=Rectlin(),
          ...
          DeepBiRNN(128, init=GlorotUniform(), batch_norm=True, activation=Rectlin(), reset_cells=True),
          RecurrentMean(),
